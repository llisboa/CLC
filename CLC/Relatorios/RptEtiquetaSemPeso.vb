...
Public Class RptEtiquetaSemPeso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CLC.RptEtiquetaSemPeso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEtiquetaSemPeso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEtiquetaSemPeso = New RptEtiquetaSemPeso
        rpt.Site = Me.Site
        Return rpt
    End Function
