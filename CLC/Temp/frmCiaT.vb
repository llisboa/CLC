...
Public Class frmCiaT
    Inherits Form

    Const TempoAteMostrarReg As Integer = 300
    Dim TT As New ToolTip

    Private Sub frmCia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        grdPrinc.Bind()
        Try
            Dim D As New Icraft.IcftBase.Defs(Apl.Esquema, "CIA;CIA_LOCAL;CIA_RAMO_ATIVIDADE", Login.Strconn, Apl.Esquema)

            For Each Linha As System.Data.DataRow In D.Campos.Tables(0).Select("TABELA='CIA'")
    ...
    Sub CarregaAtivCia()
        DSAtivCia = Icraft.IcftBase.DSCarrega("SELECT COD FROM IM.CIA", Login.Strconn)
    End Sub
    ...
    Sub MostraProg()
        ...
        Else
            ...
            DSReg = Icraft.IcftBase.DSCarrega(SQLCarrega, Login.Strconn, ":COD", DSChaves.Tables(0).Rows(RegPos - 1)("COD"))
            ...
            For Each Ctl As Object In Campos
                ...
                End If
            Next
            lblChave.Text = DSReg.Tables(0).Rows(0)("COD")
        End If
    ...
    ReadOnly Property SQLCarrega() As String
        Get
            If _SQLCarrega = "" Then
                ...
                Next
                _SQLCarrega = "SELECT " & SQL & " FROM IM.CIA WHERE COD=:COD"
            End If
            Return _SQLCarrega
        End Get
    End Property
    ...
    ReadOnly Property SQLChave() As String
        Get
            Dim SQL As String = "SELECT COD FROM IM.CIA"
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        Try
            Icraft.IcftBase.GravaReg("fld", tabPrinc, "IM.CIA", "COD=:F_COD", Login.Strconn, Nothing, ":F_COD", lblChave.Text)
            AtualizaChaves()
            GravaAtividades()
            GravaEntrega()
