...
Public Class frmPontoColetaComViagem
    ...
    Sub Atualizar()
        Try
            Dim SQL As String = "SELECT DISTINCT NVL(TRUNC(CARREGA_ATA),TRUNC(CARREGA_ETA)) XTA, CARREGA_NOME, VIAGEM_REF FROM IM.VW_COL_INSTRUCAO WHERE CARREGA_NOME IS NOT NULL ORDER BY XTA DESC"
            grdPrinc.StrConn = Login.Strconn
            grdPrinc.Usuario = Login.Usuario!usuario
            grdPrinc.SQL = SQL
            grdPrinc.ColunaNomes = "Data de Carregamento;Ponto de Coleta;Viagem"
            grdPrinc.Bind()
    ...
    Private Sub btnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimir.Click
        If SQL = "" Then
            MsgBox("Favor selecionar uma linha.", vbOKOnly + vbCritical, "Erro!")
        Else
