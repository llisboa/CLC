Public Class frmVolumesDimensaoNCM

    Private Sub frmVolumesDimensaoNCM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub Atualizar()
        ...
        Try
            ...
            grdPrinc.SQL = SQL
            grdPrinc.ColunaNomes = "Status;NCM;Produto;Especificações;Quantidade;Peso Líquido;Peso Bruto"
